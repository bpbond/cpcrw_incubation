...
This in turns means that the role of established, structured data and code repositories is critical. These provide a much-needed improvement on "Supplementary Information" sections accompanying journal articles, which have become *de facto* repositories of data, but often accessible only in inconvenient formats (e.g. PDF), have restrictions for use, and uncertain long-term availability {Molloy, 2011 #4366;Neylon, 2012 #4367}. Finally, most journals do not have expertise in data storage and management {Cassey, 2006 #4349}. In contrast, the best repositories provid easy data uploading, assignment of data digital object identifiers (DOIs), and long-term stability and availability. They do, however, eliminate all risks: for example, the genomics sciences have a long history of requiring sequences to be deposited, but there are multiple repositories of varying curatorial levels, data quality, and formats, causing longer-term problems {Lagesen, 2010 #4369}.

**Institutional and social trust**

Finally, there are longer-term issues of trust to consider. 

An explicit governemntal rationale for increasing transparency and open data in science
...
* Log files provide an audit trail {Ellison, 2010 #4363} of what analytical steps were taken and, critically, the specific versions used for each unit of software, including the main R system itself. This is critical as software changes with time, a potentially big problem in reproducing previous analyses.
