...
We have supplemented this section with a better comparison to relevant literature, for example, Lavoie et al. (2011), Sistla et al. (2012), and Bouskill et al. (2014). {\bf See new lines LINES.}
...
This is similar to the referee's comment 1.9 (please see our response to that below), with the added factor of C quality. We have addressed this more explicitly in our revision, referring for example to incubation studies on this question (Fierer et al. 2005). {\bf See new lines LINES.}
...
This is an interesting suggestion. We do not observe any evidence for changes in CO2 moisture sensitivity with time, and weak changes in CO2 temperature sensitivity; CH4 emissions show a weak decline in moisture sensitivity with time. This is now discussed in the text. {\bf See new lines LINES.}
...
We appreciate this useful advice and question. We have diminished the emphasis on defending this finding, and instead try to place it in the context of soil characteristics in this mixed-species boreal forest, SOC quality, etc. {\bf See new lines LINES.}
...
We agree that referring and comparing to studies such as Lavoie et al. (2011) and Bouskill et al. (2014), which focused specifically on high latitudes, would be a useful addition. We don't know of any studies examining the N limitation of deep soils at this site. We will discuss these results in our revision, along with other studies examining the relationship between N availability and C mineralization. {\bf See new lines LINES.}
