...
**Figure 4.** Cumulative C fluxes (mg g C^-1^) over the incubation, by gas (CO~2~ and CH~4~, top and bottom panels respectively) and treatment (columns). Letters within a panel indicate significant differences based on Tukey's HSD.
