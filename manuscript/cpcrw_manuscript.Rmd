...
**Table 1.** Summary of dissolved organic carbon (DOC), percent C, percent N, and CO~2~ and CH~4~ fluxes by treatment. Each column summarizes (mean ± s.d.) 12 cores, combining two groups of N=6 at each incubation temperature, except for the pre-incubation values shown in the right-hand column (N=6). 
