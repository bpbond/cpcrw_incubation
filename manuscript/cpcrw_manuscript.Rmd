...
knitr::kable(WC_effect, digits = 3, 
             col.names = c("Treatment", "Temperature", "Gas", "R<sup>2</sup>", "Sigma", "P", "AIC"))
```
...
**Figure 2.** A faceted (Temperature ~ Treatment) plot showing normalized flux means and errors by incubation time. (Basically the figure already in the README diagnostics.)

**Figure 3.** Cumulative fluxes over the incubation.
