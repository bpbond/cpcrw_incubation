...
The production of C from CO~2~ was over `r minmag` order of magnitudes higher than that from CH~4~, with CO~2~:CH~4~ ratios ranging from `r minratio` million in the `r mintemp` °C `r maxtrt` treatment, to `r maxratio` million in the `r maxtemp` °C `r maxtrt` treatment.
